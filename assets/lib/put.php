...
if ($table == "recipe"){
	...
	if ($action == "insert"){
		...
		$insert = "INSERT INTO recipe ('title', 'ingredients', 'recipe', 'category', 'time', 'portions', 'img', 'things', 'ingrCat') VALUES('$title','$ingredients', '$recipe','$category','$timeMaking','$noPortions', '$recipeImage', '$thingsNeeded', '$ingrCatName')";
